...
def save_confusion_matrix(y_true, y_pred, model_name):
    ...
    filename = f"confusion_matrix_{model_name.lower().replace(' ', '_')}.png"  # noqa: E501
...
# Функция для логирования модели и метрик
def log_model_with_metrics(
    ...
    with mlflow.start_run(run_name=f"{model_name}_{timestamp}") as run:
        ...
        report_filename = f"classification_report_{model_name.lower().replace(' ', '_')}.txt"  # noqa: E501
